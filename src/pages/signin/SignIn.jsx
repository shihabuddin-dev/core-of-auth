...
const SignIn = () => {
    const { handleLogin ,createUserWithGoogle} = use(ValueContext)
    ...
    return (
        <div className="w-full max-w-md mx-auto p-4 rounded-md shadow sm:p-8 dark:bg-gray-50 dark:text-gray-800">
            ...
            <p className="text-sm text-center dark:text-gray-600">Don't have account?
                <Link to='/signup' className="focus:underline text-indigo-600 hover:underline">Sign up here</Link>
            </p>
            <div className="my-6 space-y-4">
                <button onClick={handleGoogleLogin} aria-label="Login with Google" type="button" className="flex items-center justify-center w-full p-4 space-x-4 border rounded-md focus:ring-2 dark:border-gray-600 ">
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <button type="submit" className="w-full px-8 py-3 font-semibold rounded-md dark:bg-indigo-600 dark:text-gray-50">Sign in</button>
            </form>
        </div>
    );
};
